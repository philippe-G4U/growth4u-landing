...
export default function NewsletterCTA() {
  ...
  if (step === 'done') {
    return (
      <div className="my-10 bg-[#6351d5]/5 border border-[#6351d5]/20 rounded-2xl p-6 flex items-center gap-4">
        ...
        <div>
          <p className="font-bold text-[#032149]">¡Listo, {formData.nombre.split(' ')[0]}!</p>
          <p className="text-slate-500 text-sm">Ya estás dentro. Cada semana, contenido accionable directo a tu bandeja.</p>
        </div>
      </div>
    );
  }
